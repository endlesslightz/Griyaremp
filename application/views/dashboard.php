...
<body>
	...
	<div class="container-fluid fixed">
		...
		<div class="navbar main">
			<a href="index.html?lang=en" class="appbrand"><span>Griya Rempah <span> <?php echo $title; ?></span></span></a>
		...
		<div id="menu" class="hidden-phone">
			<div id="menuInner">
				...
				<ul>
					...
					<li class="glyphicons home"><a href="<?php echo base_url('index.php/dashboard');?>"><i></i><span>Dashboard</span></a></li>
					<li class="glyphicons user"><a href="<?php echo base_url('index.php/member');?>"><i></i><span>Member</span></a></li>
					<li class="glyphicons charts"><a href="<?php echo base_url('index.php/pengaturan');?>"><i></i><span>Pengaturan</span></a></li>
					<li class="hasSubmenu">
...
<br/>		
	...
	<!-- Notyfy -->
	<script type="<?php echo base_url();?>assets/text/javascript" src="theme/scripts/notyfy/jquery.notyfy.js"></script>
	
	<!-- Dashboard Custom Script -->
	<script type="<?php echo base_url();?>assets/text/javascript" src="theme/scripts/index.js"></script>
	
	<script type="t<?php echo base_url();?>assets/ext/javascript" src="https://www.google.com/jsapi"></script>

		<!-- Sparkline -->
	<script src="<?php echo base_url();?>assets/theme/scripts/jquery.sparkline.js" type="text/javascript"></script>
