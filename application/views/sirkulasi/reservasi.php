...
<?php $this->load->view('backend/tema/sidebar');?>
				...
				<div id="main_content">
					...
					<h2 class="grid_12">Sirkulasi - Daftar Reservasi</h2>
					<div class="clean"></div>		
							<br>
						<p>Masukkan Filter Kode Anggota  : </p>
					<?php 
					
					echo form_open('backend/sirkulasi/lihat_reservasi'); 
					...
					<?php if($hasil_search->num_rows > 0): ?>
						...
						<div class="box">
							<div class="header">
								<h3>Data Reservasi</h3><span></span>
							</div>
							<div class="content no-padding">
								<table cellpadding="5" width=100% border=1class="table">
										...
										<td width="10%" style="background: #EEEEEE;"><strong>Tanggal Reservasi</strong></td>
									</tr>
									<?php 
								...
								?>
									...
									<tr>
										...
										<td width="10%"><?php echo $hasil_search->reserve_date; ?></td>
