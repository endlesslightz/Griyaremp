...
<?php $this->load->view('backend/tema/sidebar');?>
				...
				<div id="main_content">
					...
					<h2 class="grid_12">Sirkulasi - Daftar Keterlambatan</h2>
					<div class="clean"></div>		
							<br>
						<p>Masukkan Filter Kode Anggota  : </p>
					<?php 
					
					echo form_open('backend/sirkulasi/keterlambatan'); 
					...
					<?php if($hasil_search->num_rows > 0): ?>
						...
						<div class="box">
							<div class="header">
								<h3>Data Keterlambatan</h3><span></span>
							</div>
							<div class="content no-padding">
								<table cellpadding="5" width=100% border=1class="table">
										...
										<td width="10%" style="background: #EEEEEE;"><strong>Keterlambatan</strong></td>
									</tr>
									<?php 
								
									foreach($hasil_search->result() as $hasil_search):
										$date = date('Y-m-d'); 
									$terlambat = strtotime($date) - strtotime($hasil_search->due_date);
									$terlambat =round($terlambat / 86400);
								?>
									...
									<tr>
										...
										<td width="10%"><?php echo $terlambat; ?> hari</td>
