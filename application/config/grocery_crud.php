<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['grocery_crud_default_per_page']	= 5; //Can only take values 10,25,50,100
	...
	$config['grocery_crud_file_upload_max_file_size'] 			= '5MB'; //ex. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)
